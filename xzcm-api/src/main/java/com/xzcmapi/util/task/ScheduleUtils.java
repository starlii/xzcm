package com.xzcmapi.util.task;

import com.xzcmapi.common.Constant;
import com.xzcmapi.config.task.AsyncJobFactory;
import com.xzcmapi.config.task.SyncJobFactory;
...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, String jobName, String jobGroup) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new XzcmBaseRuntimeException("获取定时任务CronTrigger出现异常");
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, String jobName, String jobGroup,
        ...
        try {
            ...
            if(Constant.JobStatus.PAUSE.getValue() == scheduleJob.getStatus()){
                pauseJob(scheduler, scheduleJob.getJobName(), scheduleJob.getJobGroup());
            }
        } catch (SchedulerException e) {
            log.error("创建定时任务失败", e);
            throw new XzcmBaseRuntimeException("创建定时任务失败");
        }
    }
    ...
    public static void runOnce(Scheduler scheduler, String jobName, String jobGroup) {
        ...
        try {
            ...
            throw new XzcmBaseRuntimeException("运行一次定时任务失败");
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, String jobName, String jobGroup) {
        ...
        try {
            ...
            throw new XzcmBaseRuntimeException("暂停定时任务失败");
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, String jobName, String jobGroup,
        ...
        try {
            ...
            throw new XzcmBaseRuntimeException("更新定时任务失败");
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, String jobName, String jobGroup) {
        try {
            ...
            throw new XzcmBaseRuntimeException("删除定时任务失败");
        }
    }
}